...
3. 10:24 "QQQ 716C … 105.00" refused, price makes no sense (ask 0.91). SAME as 9/16 item 2 (Skyy "112" = 1.12): the caller drops the decimal. Skyy's QQQ 716C trimmed +50%. Still waiting on G's ruling from 9/16. Verdict: G 9/17: YES — built (whole number, 1/100th fits the ask).
