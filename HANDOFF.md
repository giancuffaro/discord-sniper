...
Last updated: 2026-09-13 — UI cleanup and 50-message observer context; 3.8.17 reload unverified.
...
- PROVIDER KEYS: Keys pane saves OpenAI, Gemini, Perplexity and DeepSeek credentials under settings.json ai_provider_keys. Storage only; no validation requests or activation. Status returns presence flags only; inputs are not included in browser draft persistence.
