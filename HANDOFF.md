...
Last updated: 2026-09-18 — the LEVEL shape (pullback-to-round-number futures entry) is defined, shadowed daily, and blocked from live only by the futures data subscription. CME single-stock futures NON-TRADABLE at Webull (NT).
