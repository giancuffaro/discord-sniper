...
Last updated: 2026-09-19 — the futures simulator's look-ahead bug found and fixed; the level shape is NOT an edge under the honest sim (callers = coin flip); index mirror should be OFF. A year of ES/NQ bars and four room grabs are in.
