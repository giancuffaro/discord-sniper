...
Last updated: 2026-09-18 — CME single-stock futures are listed NON-TRADABLE at Webull (status NT); single-name alerts replayed as micro stock futures (measurement, stock bars). Hard take-profit close removed 9/17; ratchet is the only exit.
