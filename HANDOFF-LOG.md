...
reference/ratchet_sweep.py -> RATCHET-SWEEP.txt. Stops 5..35 x arm none/0.5/0.75/1/1.5x x rungs 0.25/0.5/1x x target none/1/1.5/2/3x = 520 per instrument, on the same 64 SPY/MES and 40 QQQ/MNQ alerts; each combo also scored on the first and second half of the days (overfit guard).
