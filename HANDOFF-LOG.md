...
CLOCK (9/19 03:45 ET): the stamps from 9/17 19:15 ET through 9/19 03:25 ET were re-set from file times (UTC-4; a few interpolated between them) — the session had guessed them, up to nine hours ahead of the files. The 9/17 "UTC" stamps are as written. Rule: a stamp comes from `date` on the machine, never from memory.
...
### 2026-09-17 (21:00 ET) — rip-out: hard take-profit close, the duplicate stop setting, typed popup numbers
...
### 2026-09-17 (20:15 ET) — voice entries: not ready; instant-vs-pullback before 10:00; stale sweep
...
### 2026-09-17 (19:30 ET) — dropped decimal, fade test, Chika's frozen pills, a stale popup label
