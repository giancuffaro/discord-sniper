...
- When an operating rule changes, edit the relevant rule in `HANDOFF.md` in place, keep that file under 50 KB, put session history in `HANDOFF-LOG.md`, and sync `project/context/HANDOFF-snapshot.md` as its own instructions require.
