...
/* WHOP API FEED removed 9/8 — the bridge-side reader it polled never worked
 * (wrong Whop endpoints) and its "active" ping silently killed the working
 * browser-tab reads. Whop reads come only from whop.js in the tab now. This
 * page stays for VOICE (Deepgram) capture below. */
