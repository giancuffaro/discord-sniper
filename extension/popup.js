...
// away. Each requests at least one year.
$("grabHistory").onclick = async () => {
  ...
  el.textContent = "added to the queue — the extension will bring it to the front, grab one year, save it, keep the tab open, and move to the next. Watch the Logs tab.";
